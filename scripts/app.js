...
// ================= CONFIGURATION =================
const CONFIG = {
  GAS_URL: 'https://script.google.com/macros/s/AKfycbz7wq7XgW0LEeYRJLG3_3FkrAe6p5JaBjA2pFYqr4qrWs7sS6z6s6ydv4jjpUYLHGjzmA/exec',
...
function validateItemCategory(category) {
  const validCategories = [
    ...
    '*CHAPTER 71.18 GOLD COIN',
    '*CHAPTER 71.14 GOLDSMITHS ; SILVERSMITHS WARES',
    '*CHAPTER 6 LIVE PLANTS ( ITEM KAWALAN )',
    '*CHAPTER 33.01 ESSENTIAL OIL',
    '*CHAPTER 33.03 PERFUME',
    '*CHAPTER 33.04 BEAUTY OR MAKEUP PREPARATIONS',
    '*CHAPTER 33.05 SHAMPOO ; HAIR CARE',
    '*CHAPTER 33.06 ORAL TOOTHPASTE ;DENTAL HYGIENE',
    '*CHAPTER 33.07 DEODORANTS ; BATH SALTS ; INCENSE ; ROOM PERFUMING ; EYE SOLUTION',
    'CHAPTER 34.06 CANDLE',
    'CHAPTER 34.05 POLISHES AND CREAM',
    'CHAPTER 39 PLASTICS AND ARTICLES THEREOF',
    'CHAPTER 92 MUSICAL INSTRUMENT ; PARTS ACCESSORIES',
    'CHAPTER 96.18 TAILOR DUMMIES FIGURES',
    'CHAPTER 84.14.51 FAN ; PORTABLE FAN',
    'CHAPTER 84.14.10 AIR OR VACUUM PUMP',
    'CHAPTER 8422 DISH WASHING MACHINES ; PACKING ; WRAPING MACHINE ; PARTS',
    'CHAPTER 5703 CARPET ; CARPET KERETA ; SEJADAH',
    'CHAPTER 2710.19 LUBRICATING OIL ; GREASES',
    '*CHAPTER 2101 COFFEE ; TEA INSTANT',
    '*CHAPTER 2103 SAMBAL SAUCE ; SAMBAL NYET',
    'CHAPTER 4202 BAG ; WALLET',
    'CHAPTER 7020 HANDPHONE SCREEN PROTECTOR ; LCDs',
    '*OTHERS'
  ];
