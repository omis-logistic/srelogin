...
function validateItemCategory(category) {
  const validCategories = [
    ...
    'ARTICLES OF STONE',
    'ARTIFICAL FLOWER',
    'AUTOPARTS ; CAR ACCESSORIES',
    'BAJU BABY ; AND ACCESSORIES',
    'BAJU ; PAKAIAN  ; SET SUIT',
    '*BEAUTY OR MAKEUP PREPARATIONS',
    'BEDDING SET ; CUSHION ; PILLOW',
    'BLANKET',
    'BRA ; BENGKUNG ; CORSET',
    'BROOM ; BRUSH ;FLOOR MOPS SWEEPERS',
    'CANDLE',
    'CERAMIC PRODUCTS',
    'COMBS ; HAIR PIN ; AND PARTS',
    'CONTACT LENS',
    '*COCOA PREPARATION',
    'CURTAIN ; BLINDS',
    '*DEODORANTS ; BATH SALTS ; INCENSE ; ROOM PERFUMING ; EYE SOLUTION',
    'ELETRICAL',
    'SPECIAL WOVEN FABRIC ; LACE ; TAPESTRIES ; EMBROIDERY',
    '*ESSENTIAL OIL',
    'EXERCISE EQUIPMENT',
    'EYELASHES',
    'FABRIC SILK ; KAIN ; SAMPIN',
    'FAN ; PORTABLE FAN',
    'FISHING ACCESSORIES',
    'FOOTWEAR ARTICLES ; KASUT SLIPPER',
    'FURNITURE',
    'GLASS AND GLASSWARE',
    '*GOLD COIN',
    '*GOLDSMITHS ; SILVERSMITHS WARES',
    'LEATHER ; HANDBAG ; WALLET',
    '*LIVE PLANTS ( ITEM KAWALAN )',
    'HANDPHONE CASING',
    'HEADGEAR ; PARTS ; TOPI ; SONGKOK ; CAP ; INNER TUDUNG',
    '*HEADPHONE ; EARPHONE',
    'IMITATION JEWELLERY ; PIN ; BROOCH',
    'MUSICAL INSTRUMENT ; PARTS ACCESSORIES',
    '*ORAL TOOTHPASTE ;DENTAL HYGIENE',
    'PAINTS , INK',
    ...
    'POLISHES AND CREAM',
    '*PRINTED BOOK ; PICTURE',
    'RUBBER ARTICLES',
    'SANITARY TOWELS ; DIAPERS ; NAPKIN LINER',
    'SELUAR',
    '*SHAMPOO ; HAIR CARE',
    'SKIRT',
    'SOAP , DETERGENT , WASHING PREPARATION',
    'SOCKS',
    'SOLAR LIGHT',
    'STICKER',
    '*SUGAR CONFECTIONERY',
    ...
    'TELEKUNG',
    '*TELEPHONE SET ; WIRELESS NETWORK ; OTHERS',
    'TISSUE ; NAPKIN',
    ...
    'TRIPODS',
    'HANDSOCK',
    'TAILOR DUMMIES FIGURES',
    'TUDUNG ; SHAWL ; SCARVES',
    'TUMBLER VACUUM FLASK ; PARTS ACCESSORIES',
    'UMBRELLA',
    'UNDERWEAR ; PANTIES',
    'USED PERSONAL OR HOUSEHOLD EFFECT',
    'WALL MOUNT ; POWDER PUFFS SPONGE',
